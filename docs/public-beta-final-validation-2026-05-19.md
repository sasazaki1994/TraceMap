...
```bash
export TRACEMAP_ANSWER_GRAPH_PROVIDER=openai
export TRACEMAP_OPENAI_MODEL=gpt-4o-mini
export TRACEMAP_OPENAI_TIMEOUT_MS=60000
export TRACEMAP_OPENAI_API_KEY=... # or export OPENAI_API_KEY=...
pnpm dev
```
