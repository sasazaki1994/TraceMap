...
describe("buildBriefingReport", () => {
  it("builds markdown with summary, claims, sources, unknowns, and lineage", () => {
    ...
    expect(markdown).toContain("> Beta Notice: This report was generated by TraceMap Public Beta.");
    ...
    expect(markdown).toContain("TraceMap does not provide investment, legal, medical, or professional advice.");
